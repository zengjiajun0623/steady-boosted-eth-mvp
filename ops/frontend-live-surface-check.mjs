...
const APP_REQUIREMENTS = [
  ...
  {
    area: "trader",
    name: "live vault-backed buy and sell",
    patterns: [
      "submitOnchainTrade",
...
const SELECTOR_SIGNATURES = [
  ...
  ["ammToken", "token()"],
  ["buySteady", "buySteady(address,bytes32,address,uint256,address)"],
  ["buyBoosted", "buyBoosted(address,bytes32,address,uint256,address)"],
  ["sellSteady", "sellSteady(address,bytes32,address,uint256,uint256,address)"],
  ["sellBoosted", "sellBoosted(address,bytes32,address,uint256,uint256,address)"],
  ["quoteBuyProduct", "quoteBuyProduct(address,uint256)"],
  ["quoteSellProduct", "quoteSellProduct(address,uint256)"],
  ["deposit", "deposit()"],
